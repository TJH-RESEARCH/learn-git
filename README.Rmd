...
This way of setting aliases within git is still a little cumbersome. After all, you have to type out git first this the alias. The other, more common way, of using aliases with the command line is to set them up in zsh/bash etc
