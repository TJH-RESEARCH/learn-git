...
It is also common that there have been no commits on the main branch while there have been commits on the feature branch. In this case, the feature branch is just a linear path from the main branch. Merging while on the main branch performs a "fast forward".  
